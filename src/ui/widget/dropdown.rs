// https://github.com/linebender/druid-widget-nursery/blob/cad6bcb7eababdc5958478098d4a60dd816aa194/src/dropdown.rs
...
const DROPDOWN_SHOW: Selector = Selector::new("app.dropdown.show");
const DROPDOWN_HIDE: Selector = Selector::new("app.dropdown.hide");
const DROPDOWN_CLOSED: Selector = Selector::new("app.dropdown.closed");
